...
App.Http.BusinessSettings = function () {
  ...
  function save(businessSettings) {
    var url = App.Utils.Url.siteUrl('business_settings/save');
    var data = {
  ...
  function applyGlobalWorkingPlan(workingPlan) {
    var url = App.Utils.Url.siteUrl('business_settings/apply_global_working_plan');
    var data = {
      csrf_token: vars('csrf_token'),
  ...
  return {
    save: save,
    applyGlobalWorkingPlan: applyGlobalWorkingPlan
  };
}();