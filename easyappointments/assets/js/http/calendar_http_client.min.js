...
App.Http.Calendar = function () {
  ...
  function saveAppointment(appointment, customer, successCallback, errorCallback) {
    var url = App.Utils.Url.siteUrl('calendar/save_appointment');
    var data = {
  ...
  function deleteAppointment(appointmentId, deleteReason) {
    var url = App.Utils.Url.siteUrl('calendar/delete_appointment');
    var data = {
      csrf_token: vars('csrf_token'),
  ...
  function saveUnavailability(unavailability, successCallback, errorCallback) {
    var url = App.Utils.Url.siteUrl('calendar/save_unavailability');
    var data = {
      csrf_token: vars('csrf_token'),
  ...
  function deleteUnavailability(unavailabilityId) {
    var url = App.Utils.Url.siteUrl('calendar/delete_unavailability');
    var data = {
      csrf_token: vars('csrf_token'),
  ...
  function saveWorkingPlanException(date, workingPlanException, providerId, successCallback, errorCallback) {
    var url = App.Utils.Url.siteUrl('calendar/save_working_plan_exception');
    var data = {
      csrf_token: vars('csrf_token'),
      date: date,
  ...
  function deleteWorkingPlanException(date, providerId, successCallback, errorCallback) {
    var url = App.Utils.Url.siteUrl('calendar/delete_working_plan_exception');
    var data = {
      csrf_token: vars('csrf_token'),
      date: date,
      provider_id: providerId
  ...
  function getCalendarAppointments(recordId, startDate, endDate, filterType) {
    var url = App.Utils.Url.siteUrl('calendar/get_calendar_appointments');
    var data = {
      csrf_token: vars('csrf_token'),
      record_id: recordId,
  ...
  function getCalendarAppointmentsForTableView(startDate, endDate) {
    var url = App.Utils.Url.siteUrl('calendar/get_calendar_appointments_for_table_view');
    var data = {
      csrf_token: vars('csrf_token'),
      start_date: moment(startDate).format('YYYY-MM-DD'),
      end_date: moment(endDate).format('YYYY-MM-DD')
  ...
  return {
    ...
    saveWorkingPlanException: saveWorkingPlanException,
    deleteWorkingPlanException: deleteWorkingPlanException,
    getCalendarAppointments: getCalendarAppointments,
    getCalendarAppointmentsForTableView: getCalendarAppointmentsForTableView
  };
}();