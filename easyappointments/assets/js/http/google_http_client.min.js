...
App.Http.Google = function () {
  ...
  function selectGoogleCalendar(providerId, googleCalendarId) {
    var url = App.Utils.Url.siteUrl('google/select_google_calendar');
    var data = {
  ...
  function disableProviderSync(providerId) {
    var url = App.Utils.Url.siteUrl('google/disable_provider_sync');
    var data = {
      csrf_token: vars('csrf_token'),
      provider_id: providerId
    };
  ...
  function getGoogleCalendars(providerId) {
    var url = App.Utils.Url.siteUrl('google/get_google_calendars');
    var data = {
      csrf_token: vars('csrf_token'),
      provider_id: providerId
    };
  ...
  function syncWithGoogle(providerId) {
    var url = App.Utils.Url.siteUrl('google/sync/' + providerId);
    return $.get(url);
  }

  return {
    getGoogleCalendars: getGoogleCalendars,
    selectGoogleCalendar: selectGoogleCalendar,
    disableProviderSync: disableProviderSync,
