...
window.App.Utils.Date = function () {
  ...
  function format(dateValue) {
    var dateFormatType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'YMD';
    var timeFormatType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'regular';
    var withHours = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var dateMoment = moment(dateValue);

    if (!dateMoment.isValid()) {
      throw new Error("Invalid date value provided: ".concat(dateValue));
    }
    ...
    switch (dateFormatType) {
      ...
      default:
        throw new Error("Invalid date format type provided: ".concat(dateFormatType));
    }
    ...
    switch (timeFormatType) {
      ...
      default:
        throw new Error("Invalid time format type provided: ".concat(timeFormatType));
    }

    var format = withHours ? "".concat(dateFormat, " ").concat(timeFormat) : dateFormat;
  ...
  function getWeekdayId(weekDayName) {
    ...
    switch (weekDayName.toLowerCase()) {
      ...
      default:
        throw new Error("Invalid weekday name provided: ".concat(weekDayName));
    }
  ...
  function getWeekdayName(weekDayId) {
    ...
    switch (weekDayId) {
      ...
      default:
        throw new Error("Invalid weekday Id provided: ".concat(weekDayId));
    }
