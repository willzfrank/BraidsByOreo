...
App.Pages.Recovery = function () {
  ...
  var $email = $('#email');
  var $getNewPassword = $('#get-new-password');
  /**
  ...
  function onFormSubmit(event) {
    ...
    var email = $email.val();
    App.Http.Recovery.perform(username, email).done(function (response) {
      ...
      if (response.success) {
        ...
        $alert.text('The operation failed! Please enter a valid username ' + 'and email address in order to get a new password.');
      }
    });
  }
