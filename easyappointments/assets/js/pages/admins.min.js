...
App.Pages.Admins = function () {
  ...
  var $filterAdmins = $('#filter-admins');
  var filterResults = {};
  var filterLimit = 20;
  /**
  ...
  function addEventListeners() {
     ...
     */
    $admins.on('blur', '#username', function (event) {
      ...
      App.Http.Account.validateUsername(adminId, username).done(function (response) {
    ...
    $admins.on('click', '.admin-row', function (event) {
      ...
      var admin = filterResults.find(function (filterResult) {
  ...
  function save(admin) {
    App.Http.Admins.save(admin).then(function (response) {
  ...
  function remove(id) {
    App.Http.Admins.destroy(id).then(function () {
  ...
  function filter(keyword) {
    ...
    App.Http.Admins.search(keyword, filterLimit).then(function (response) {
      ...
      if (!response.length) {
        $filterAdmins.find('.results').append($('<em/>', {
