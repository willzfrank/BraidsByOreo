...
App.Pages.GeneralSettings = function () {
  ...
  var $companyLogoPreview = $('#company-logo-preview');
  var $removeCompanyLogo = $('#remove-company-logo');
  var $companyColor = $('#company-color');
  var $resetCompanyColor = $('#reset-company-color');
  var companyLogoBase64 = '';
  /**
  ...
  function isInvalid() {
    try {
      $('#general-settings .is-invalid').removeClass('is-invalid'); // Validate required fields.
  ...
  function onCompanyLogoChange() {
    ...
    App.Utils.File.toBase64(file).then(function (base64) {
  ...
  function initialize() {
    ...
    var generalSettings = vars('general_settings');
