...
App.Components.WorkingPlanExceptionsModal = function () {
  ...
  function onAddBreakClick() {
    ...
    }).appendTo('#working-plan-exceptions-breaks tbody'); // Bind editable and event handlers.
  ...
  function onEditBreakClick() {
    ...
    $(this).closest('tr').find('.working-plan-exceptions-break-start').focus(); // Show save - cancel buttons.
  ...
  function onSaveBreakClick() {
    ...
    var $tr = $(this).closest('tr');
    var start = moment($tr.find('.working-plan-exceptions-break-start input').val(), vars('time_format') === 'regular' ? 'h:mm a' : 'HH:mm');
    var end = moment($tr.find('.working-plan-exceptions-break-end input').val(), vars('time_format') === 'regular' ? 'h:mm a' : 'HH:mm');

    if (start > end) {
      $tr.find('.working-plan-exceptions-break-end input').val(start.add(1, 'hour').format(vars('time_format') === 'regular' ? 'h:mm a' : 'HH:mm'));
    }
