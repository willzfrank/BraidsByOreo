...
App.Components.UnavailabilitiesModal = function () {
  ...
  var $id = $('#unavailability-id');
  var $startDatetime = $('#unavailability-start');
  var $endDatetime = $('#unavailability-end');
  var $selectProvider = $('#unavailability-provider');
  var $notes = $('#unavailability-notes');
  var $saveUnavailability = $('#save-unavailability');
  var $insertUnavailability = $('#insert-unavailability');
  ...
  function addEventListeners() {
    ...
    $saveUnavailability.on('click', function () {
      ...
      var endMoment = moment($endDatetime.datetimepicker('getDate'));
      ...
      if (startMoment.isAfter(endMoment)) {
        ...
        $unavailabilitiesModal.find('.modal-message').text(lang('start_date_before_end_error')).addClass('alert-danger').removeClass('d-none');
        $startDatetime.addClass('is-invalid');
        $endDatetime.addClass('is-invalid');
        return;
      ...
      var successCallback = function successCallback() {
        ...
        App.Layouts.Backend.displayNotification(lang('unavailability_saved')); // Close the modal dialog and refresh the calendar appointments.
    ...
    $insertUnavailability.on('click', function () {
      resetModal();
      var $dialog = $('#unavailabilities-modal'); // Set the default datetime values.
      ...
      $endDatetime.val(App.Utils.Date.format(startMoment.add(1, 'hour').toDate(), vars('date_format'), vars('time_format'), true));
  ...
  function resetModal() {
    $id.val(''); // Set default time values

    var start = App.Utils.Date.format(moment().toDate(), vars('date_format'), vars('time_format'), true);
    var end = App.Utils.Date.format(moment().add(1, 'hour').toDate(), vars('date_format'), vars('time_format'), true);
    var dateFormat;
    ...
    var firstWeekdayId = App.Utils.Date.getWeekdayId(firstWeekday);
    ...
    $endDatetime.val(end); // Clear the unavailability notes field.
