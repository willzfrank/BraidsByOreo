...
App.Components.ColorSelection = function () {
  ...
  function onColorSelectionOptionClick(event) {
    ...
    var $colorSelection = $target.closest('.color-selection');
  ...
  function setColor($target, color) {
    $target.find('.color-selection-option').removeClass('selected').each(function (index, colorSelectionOptionEl) {
  ...
  function applyBackgroundColors() {
    $(document).find('.color-selection-option').each(function (index, colorSelectionOptionEl) {
      var $colorSelectionOption = $(colorSelectionOptionEl);
      var color = $colorSelectionOption.data('value');
